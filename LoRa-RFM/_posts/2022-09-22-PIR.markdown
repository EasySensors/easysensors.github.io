---
layout: post
title: Wireless Arduino compatible PIR with LoRa or RFM 69 radio on board.

description: Comes with nice enclosure, light and Temp Humidity sensors. 

image: https://github.com/EasySensors/easyPIRmultisensorsBox2/blob/master/pics/Easy_PIR_MAIN_new.png?raw=true
...
>[GitHub code repo link](https://github.com/EasySensors/easyPIRmultisensorsBox2/blob/master/easyPirPCINTdoorSensorTindie.ino)
