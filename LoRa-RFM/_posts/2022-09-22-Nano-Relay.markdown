---
layout: post
title: Wireless Arduino compatible DIN rail relay  with LoRa or RFM 69 radio on board.

description: Comes with DIN rail enclosure. 

image: https://github.com/EasySensors/nanoRelayBox/blob/master/pics/Arduino_nano_relay_box_4cr.jpg?raw=true

---

>[GitHub code repo link](https://github.com/EasySensors/nanoRelayBox/blob/master/nanoRelayBox.ino)
